...
public class SetShengJiFragment extends BaseFragment implements OnClickListener,
		BackClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = null;
		try {
			view = inflater.inflate(R.layout.system_shengji_layout, container, false);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void initView(View view) {
		bottomPage = (KtvBottomPageWidget)view.findViewById(R.id.sys_shengji_back);
	...
	{
		KtvConfirmDialog confirm = new KtvConfirmDialog(getActivity(), "是否要升级主程序?"){
			@Override
			public void noClick() {
				super.noClick();
				back();
