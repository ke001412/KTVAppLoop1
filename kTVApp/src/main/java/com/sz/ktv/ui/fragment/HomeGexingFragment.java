...
public class HomeGexingFragment extends BaseFragment implements
    ...
    private static final String TAG = "HomeGexingFragment";
    //zhangke 20171016 add for faster begin
    private View mFragmentView;
    //zhangke 20171016 add for faster end
...
//			refreshAllSinger();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mFragmentView == null) {
            try {
                mFragmentView = inflater.inflate(R.layout.gexing_layout, container, false);
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void initData() {
        ...
        new Thread() {
            public void run() {
                ...
                SongPage songPage = SingerUtil.getInstance().getDefaultSingerList(DEFAULT_INIT_SIZE);
                long time2 = System.currentTimeMillis();
                LogUtil.log(TAG, "initData： " + (time2 - time1));
    ...
    private static final int DEFAULT_INIT_SIZE = 3;
...
//            scrollLayout.setOffscreenPageLimit(DEFAULT_INIT_SIZE);
