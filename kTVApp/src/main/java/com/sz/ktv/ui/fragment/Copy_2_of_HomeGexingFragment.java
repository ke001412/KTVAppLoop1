...
public class Copy_2_of_HomeGexingFragment extends BaseFragment implements
	...
	private void initData() {
		...
		new Thread(){
			public void run() {
				...
				SongPage songPage = SingerUtil.getInstance().getSingerPage(1);
...
//		bottomPage.setCurrentPage(currentpage);
	...
	protected void initSingerView(SongPage singerPag) {
		...
		firstPageList = singerPag.getPreSingerPageList();
		firstAdapter.setData(firstPageList);
		firstPage.reLoadView();

		secondPageList = singerPag.getCurrentSingerPageList();
		secondAdapter.setData(secondPageList);
		secodePage.reLoadView();

		thirdPageList = singerPag.getNextSingerPageList();
		thirdAdapter.setData(thirdPageList);
		thirdPage.reLoadView();
	...
	private void initView(View view) {
		...
		scrollLayout = (ScrollLayout) view.findViewById(R.id.scroll_layout);
