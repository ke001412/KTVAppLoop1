...
public class SetUPanBoGeFragment extends BaseFragment implements OnClickListener,
		BackClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = null;
		try {
			view = inflater.inflate(R.layout.system_u_pan_boge_layout, container, false);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void initView(View view) {
		bottomPage = (KtvBottomPageWidget)view.findViewById(R.id.sys_u_boge_back);
