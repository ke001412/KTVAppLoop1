...
public class SelfAbsoluteLayout extends AbsoluteLayout 
{
    ...
    private static final int PAINT_COLOR = 0x000000;
   ...
   private  static HandWriteListener mListener;
    
    public interface HandWriteListener{
    	public void onHandResult(char [] hanzi);
    };
    
    public   static void setHandWriteListener(HandWriteListener listener)
    {
    	 mListener = listener;
    }
    /**
    ...
    private void init() 
    {
        ...
        this.setBackgroundColor(android.R.color.background_dark);
        
        {
	        ...
	        mPaint.setColor(Color.BLACK);//0xFFFF0000
...
//        canvas.drawText(mResult1, 0, 10, 5, 20 + mFontSize/2, mPaintText);
    ...
    private void recognize() 
    {
    	...
    	if(null != mListener)
    	{
    		mListener.onHandResult(mResult1);
    	}
    }
