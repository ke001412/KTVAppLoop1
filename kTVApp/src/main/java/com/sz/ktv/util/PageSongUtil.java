...
import com.sz.ktv.bean.SingerBean;
import com.sz.ktv.bean.SongBean;

public class PageSongUtil {
	...
	private boolean hasPreviousPage = false;// 是否有前一页
		...
		List<SongBean> list ;
	public PageSongUtil(int pageSize, List<SongBean> singerList)
	{
	...
	public List<SongBean> getAllData()
	{
		return list;
	}
	/**
	 ...
	 * @return
	 */
	public  List<SongBean>  getNextSongData(int currentPage) {
		...
		List<SongBean>  myList = new ArrayList<SongBean>();
		myList.clear();
	 ...
	 * @return
	 */
	public  List<SongBean>  getPreSongData(int currentPage) {
