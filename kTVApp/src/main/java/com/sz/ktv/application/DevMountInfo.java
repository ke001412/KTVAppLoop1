...
public final class DevMountInfo {
        ...
        private static DevMountInfo devMountInfo;
        ...
        public static  DevMountInfo getInstance() {
                synchronized (DevMountInfo.class) {
                        if (null == devMountInfo) {
                                devMountInfo = new DevMountInfo();
                        }
                        return devMountInfo;
                }
        }
        ...
        protected void finalize() throws Throwable {
                ...
                synchronized (DevMountInfo.class) {
                        ...
                        setDevMountInfo(null);
                        
                }
        }
        private static void setDevMountInfo(DevMountInfo str){
        	DevMountInfo.devMountInfo = str;
        }
